...
<p align="center">
  <strong>面向工程设计、规划测绘与施工深化出图的 AutoCAD 工业级插件矩阵</strong><br>
  <em>基于 C# 托管程序集核心与 AutoLISP/VLX 实用算法库的双引擎架构 · 100% AutoCAD 原生实体 · 无任何第三方代理对象</em>
</p>

<p align="center">
  <a href="https://github.com/Andyang127/InkVerseX/releases"><img src="https://img.shields.io/badge/Release-v0.1.4-007ACC?style=flat-square&logo=github" alt="Release"></a>
  <a href="https://github.com/Andyang127/InkVerseX"><img src="https://img.shields.io/badge/AutoCAD-2007~2027%20(R17~R26)-E51937?style=flat-square&logo=autodesk" alt="AutoCAD"></a>
  <a href="https://github.com/Andyang127/InkVerseX"><img src="https://img.shields.io/badge/.NET-3.5~4.8%20%7C%208.0~10.0-512BD4?style=flat-square&logo=dotnet" alt=".NET"></a>
  <a href="https://github.com/Andyang127/InkVerseX"><img src="https://img.shields.io/badge/Language-C%23%20%7C%20AutoLISP%20%2F%20VLX-239120?style=flat-square&logo=csharp" alt="Language"></a>
  <a href="https://github.com/Andyang127/InkVerseX"><img src="https://img.shields.io/badge/Arch-x86%20%7C%20x64-6E7681?style=flat-square" alt="Arch"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=flat-square" alt="License"></a>
  <a href="https://github.com/Andyang127/InkVerseX"><img src="https://img.shields.io/badge/Proxy%20Entity-0%25%20(100%25%20Native)-success?style=flat-square" alt="Proxy Entity"></a>
  <a href="https://github.com/Andyang127/InkVerseX"><img src="https://img.shields.io/badge/MSTest-43%2F43%20Passed-brightgreen?style=flat-square" alt="MSTest"></a>
  <a href="https://andyang127.github.io/InkVerseX/"><img src="https://img.shields.io/badge/Docs-GitHub%20Pages-24292F?style=flat-square&logo=githubpages" alt="Docs"></a>
</p>

<p align="center">
  <a href="https://github.com/Andyang127/InkVerseX/releases"><strong>最新安装包下载</strong></a> &nbsp;|&nbsp;
  <a href="https://andyang127.github.io/InkVerseX/"><strong>在线使用手册</strong></a> &nbsp;|&nbsp;
  <a href="#3-版本更新日志"><strong>版本日志 (v0.1.4)</strong></a> &nbsp;|&nbsp;
  <a href="#2-核心架构与技术特点"><strong>核心架构</strong></a> &nbsp;|&nbsp;
  <a href="#6-c-核心原生模块详细说明"><strong>功能模块</strong></a> &nbsp;|&nbsp;
  <a href="#8-常见问题排查-faq"><strong>常见问题 (FAQ)</strong></a> &nbsp;|&nbsp;
  <a href="#10-技术支持与联系"><strong>支持与反馈</strong></a>
</p>
...
<div style="background-color: #FEF2F2; border: 2px solid #F87171; border-left: 8px solid #DC2626; padding: 18px 22px; border-radius: 8px; margin: 20px 0; line-height: 1.7;"><div style="margin-bottom: 10px;"><span style="background-color: #DC2626; color: #FFFFFF; font-size: 12px; font-weight: bold; padding: 3px 8px; border-radius: 4px; vertical-align: middle;">特别声明</span><span style="color: #991B1B; font-size: 16px; font-weight: bold; margin-left: 8px; vertical-align: middle;">关于本项目暂未开放全部工程源码的说明</span></div><p style="margin: 0 0 10px 0; color: #374151; font-size: 14px;">墨语 X (InkVerse X) 是作者业余独立维护的开源探索项目，本仓库当前主要发布<strong>编译测试就绪的安装包与技术文档</strong>。暂未开放全部完整工程源码主要基于以下阶段性安排，望同行与开发者理解：</p><div style="color: #1F2937; font-size: 13.5px;"><p style="margin: 6px 0;"><strong style="color: #DC2626;">1. 代码重构与环境解耦：</strong>早期工程包含本地测试桩与绝对路径，作者正利用业余时间系统性清洗排版与解耦；</p><p style="margin: 6px 0;"><strong style="color: #DC2626;">2. 跨 10 世代编译依赖极重：</strong>深度适配 AutoCAD 2007 ~ 2027（R17~R26 多运行时）需配置数十 GB 的 ObjectARX SDK 与运行库。为避免因本地环境缺失产生大量编译报错，现阶段优先分发全数测试通过的安装包，确保开箱即用；</p><p style="margin: 6px 0;"><strong style="color: #DC2626;">3. 防范恶意篡改与倒卖牟利：</strong>防范黑灰产抹去作者署名或植入广告弹窗倒卖，保障一线图纸环境纯净与系统安全；</p><p style="margin: 6px 0;"><strong style="color: #DC2626;">4. 后续分批逐步开源：</strong>将按<strong>“通用几何算法 -> 独立轻量模块（输入法/图层） -> 完整工程框架”</strong>成熟一个推送一个。非常欢迎在 Issues 提出宝贵建议与反馈！</p></div></div>

- **最新安装包发布页面**：[前往 GitHub Releases 页面下载安装包](https://github.com/Andyang127/InkVerseX/releases)
- **墨语 X (InkVerse X) 使用手册**：[墨语 X 使用说明 (GitHub Pages)](https://andyang127.github.io/InkVerseX/)
- **本地离线手册查阅**：下载/克隆仓库至本地后，直接双击同级 `Readme.html` 文件打开；或在 AutoCAD 命令行输入 <kbd>INKHELP</kbd> 自动唤起
...
- **独立功能模块单独安装**：若仅需使用单一功能（例如仅需图层管理或仅需批量打印），可直接使用各子分支工程生成的独立安装包（如 `CadAutoBpFrame_Setup_v0.1.0.exe`、`CadAutoBatchPrint_Setup_v0.1.0.exe`、`CadAutoIme_Setup_v0.4.3.exe` 等）；每个独立插件均配有专属安装向导，自动配置独立启动注册表，各模块互不依赖干扰。
- **自动挂载与启动生效**：
...
<div align="center"><img src="Resources/update_%20v0.1.4.png" alt="墨语 X 工具箱控制台 v0.1.4 - 批量打印重磅集成" width="380" style="max-width: 100%; border-radius: 8px; box-shadow: 0 4px 16px rgba(0,0,0,0.15);" /><br><sub>墨语 X 工具箱控制台 (v0.1.4) · 批量打印与切图分拆全新入列</sub></div>
...
<p align="center">
  <em>版权所有 (C) 2026 InkVerse X (墨语 X). 保留所有权利。</em>
</p>
